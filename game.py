...
class Game:
    ...
    def update_objects(self, keys):
        ...
        if current_time - self.spawn_timer >= self.spawn_delay:
            enemy = Enemy(self.character, self.allies, self)
        ...
        self.enemies.update(self.character, self.bullets, self.hearts, self.shields, self.scoreboard, self.allies)
